...
\lstinputlisting{../图论/树的重心Get_Centroid.cpp}
...
\lstinputlisting{../图论/最近公共祖先LCA_Heavy-Light_Decomposition.cpp}
...
\lstinputlisting{../图论/树链剖分Heavy-Light_Decomposition.cpp}
...
\subsection{MTT任意模数Fast\_Fourier\_Transform\_MOD.cpp}
\lstinputlisting{../多项式/MTT任意模数Fast_Fourier_Transform_MOD.cpp}
...
\lstinputlisting{../字符串/最小表示法Lexicographically_Minimal_String_Rotation.cpp}
...
\lstinputlisting{../数据结构/并查集Disjoin_Set_Union.cpp}
\subsection{可撤销并查集Disjoin\_Set\_Union\_Withdrawable}
\lstinputlisting{../数据结构/可撤销并查集Disjoin_Set_Union_Withdrawable.cpp}
...
\lstinputlisting{../数据结构/二维树状数组2D_Binary_Indexed_Tree.cpp}
...
\lstinputlisting{../数据结构/动态树Link-Cut_Tree.cpp}
...
\lstinputlisting{../数论/数论分块Block_Division.cpp}
...
\lstinputlisting{../数论/中国剩余定理Chinese_Remainder_Theorem.cpp}
\subsection{拓展中国剩余定理Ex\_Chinese\_Remainder\_Theorem}
\lstinputlisting{../数论/拓展中国剩余定理Ex_Chinese_Remainder_Theorem.cpp}
...
\lstinputlisting{../数论/素数测试Miller_Rabin.cpp}
\subsection{大数分解Pollard\_Rho}
\lstinputlisting{../数论/大数分解Pollard_Rho.cpp}


\newpage
\section{组合数学}
\subsection{康托展开Cantor}
\lstinputlisting{../组合数学/康托展开Cantor.cpp}
\subsection{波利亚P\'{o}lya}
\lstinputlisting{../组合数学/波利亚Polya.cpp}
...
\lstinputlisting{../网络流/二分图最大匹配Bipartite_Graph_Maximum_Matching_Dinic.cpp}
...
\lstinputlisting{../优化算法/wqs二分+决策单调性dp.cpp}
\subsection{斜率优化Slope\_Optimization}
\lstinputlisting{../优化算法/斜率优化Slope_Optimization.cpp}

\newpage
\section{离线算法}
\subsection{莫队算法Mo}
\lstinputlisting{../离线算法/莫队算法Mo.cpp}
\subsection{线段树分治Segment\_Tree\_Partition}
\lstinputlisting{../离线算法/线段树分治Segment_Tree_Partition.cpp}
...
\lstinputlisting{../杂项/模拟退火Simulated_Annealing.cpp}
...
\lstinputlisting{../杂项/快速子集变换Fast_Subset_Transform.cpp}
\subsection{24点24\_Point}
\lstinputlisting{../杂项/24点24_Point.cpp}
